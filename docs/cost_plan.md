...
The local full-horizon rehearsal produced 5,920 host calls and 80 judge calls. Offline token counting over the exact traced prompts, histories, tools, tool calls, and visible responses estimated 16,602,486 host input tokens, 223,780 host output tokens, 107,966 judge input tokens, and 4,820 judge output tokens. This measured trace is the 1x profile. The 2x and 4x columns are transparent sensitivity cases in which all token volume is multiplied by two or four. They are not confidence intervals or hard caps.

| Stage | Rollouts | Maximum logical calls | 1x trace | 2x tokens | 4x tokens |
|---|---:|---:|---:|---:|---:|
| Paid matched canary | 2 | 750 | $2.26 | $4.53 | $9.06 |
| Weekend pilot | 16 | 6,000 | $18.12 | $36.24 | $72.47 |
| Confirmatory study | 144 | 54,000 | $163.06 | $326.12 | $652.23 |
| Persistence study | 48 | 16,560 | $50.04 | $100.08 | $200.17 |
| Defense study | 72 | 27,000 | $81.53 | $163.06 | $326.12 |
| Paper experiments, excluding canary | 280 | 103,560 | $312.75 | $625.49 | $1,250.99 |
| Total paper spend, including canary | 282 | 104,310 | $315.01 | $630.02 | $1,260.05 |

The separate 960-rollout factorial sweep is optional and overlaps with the lean paper design. Its projected cost is $1,087.06 at 1x, $2,174.11 at 2x, and $4,348.22 at 4x. Running it in addition to the lean paper would produce 1,242 paid rollouts and 464,310 maximum calls, with combined projected spend of $1,402.07 at 1x, $2,804.13 at 2x, or $5,608.27 at 4x.
